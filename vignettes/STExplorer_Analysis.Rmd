...
msfe <- addPerLocQC(msfe, gTruth = ground_truth, assay = "counts", 2, subsets = list(mito = is_mito))
sfe <- addGeometries(msfe, samples = sampleDir, sample_id = sampleNames, res = "fullres")
sfe <- addPerGeneQC(msfe, assay = "counts", version = NULL, mirror = NULL)
