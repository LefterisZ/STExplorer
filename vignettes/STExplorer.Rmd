...
>  Currently, this doesn't work well within `SpatialFeatureExperiment`. The function is not exported from the Bioconductor stable distribution. It is present though inGitHub. Maybe installing from there will solve the problem. 
...
plotQC_tissueImg(sfe = sfe_2samples, res = "lowres", type = "spot")
...
## If you see this, two reasons:
##    1. You are missing a folder named 'outs' at the end of the pathway you provided earlier
...
## NOTE: when formatting the ground truth table to import it make sure that:
