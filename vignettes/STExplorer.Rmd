...
When we are performing spatial analysis in research, we're looking to achieve one (or more) of three things:
...
Spatial autocorrelation measures can be categorised broadly into two categories; Global and Local.
