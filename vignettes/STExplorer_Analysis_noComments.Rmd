...
Our suggestion this time is to cut-off at 15%. This suggestion comes after inspecting the distribution first.
...
## Plot the heatmap
heatmap <- plotFGWC_markersHeatmap(fgwc = fgwc, m_sfe = sfe, sample_id = "JBO022", markers = markers, cluster_no = 2, cutree_cols = 5)
