...
samplesPr <- c("~/Documents/Projects_1D/Visium_Prostate/data/spaceranger_outs/Prostate_Canc_hs/PrsCncA1_Results",
               "~/Documents/Projects_1D/Visium_Liver/data/spaceranger_outs/Human_Liver/Human_Liver_Steatotic_JBO019_Results")
sample_idPr <- c("PrsCncA1","JBO019")

sfePr <- read10xVisiumSFE(samples = samplesPr[1],
                          sample_id = sample_idPr[1],
                          type = "sparse",
                          data = "raw",
                          images = "lowres",
                          style = "W",
